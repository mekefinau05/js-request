...
animalsButton.addEventListener('mouseover', () => {
    animalsButton.style.backgroundColor = 'black'
    animalsButton.style.color = 'white'
})
...
queryButton.addEventListener('mouseover', () => {
    queryButton.style.backgroundColor = 'black'
...
animalsButton.addEventListener('mouseout', () => {
    animalsButton.style.backgroundColor = '#EFEFEF'
    animalsButton.style.color = 'black'
})

repeatButton.addEventListener('mouseout', () => {
    repeatButton.style.backgroundColor = '#EFEFEF'
    repeatButton.style.color = 'black'
})

queryButton.addEventListener('mouseout', () => {
    queryButton.style.backgroundColor = '#EFEFEF'
...
// CODE HERE
axios.get('http://localhost:3000/my-query=Coding-is-Life')
